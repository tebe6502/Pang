...
//-----------------------------------------------------------------
 ...
 assignfile(f, 'mic\drabinka_OK.mic'); reset(f,1);
 blockread(f, tb0, sizeof(tb0), err);
 closefile(f);
{
 assignfile(f, 'mic\drabinka_1.mic'); reset(f,1);
 blockread(f, tb1, sizeof(tb1), err);
 closefile(f);

 assignfile(f, 'mic\drabinka_2.mic'); reset(f,1);
 blockread(f, tb2, sizeof(tb2), err);
 closefile(f);

 assignfile(f, 'mic\drabinka_3.mic'); reset(f,1);
 ...
 kula:='pm_drab0';
 assignfile(t, 'drab0.asm'); rewrite(t);
 writeln(t, '.local'#9'drab0');
 zapisz(0, 0, tb0);
// zapisz(0, 1, tb1);
// zapisz(0, 2, tb2);
// zapisz(0, 3, tb3);
 ...
 kula:='pm_drab1';
 assignfile(t, 'drab1.asm'); rewrite(t);
 writeln(t, '.local'#9'drab1');
 zapisz(40, 0, tb0);
// zapisz(40, 1, tb1);
// zapisz(40, 2, tb2);
// zapisz(40, 3, tb3);
 ...
 kula:='pm_drab2';
 assignfile(t, 'drab2.asm'); rewrite(t);
 writeln(t, '.local'#9'drab2');
 zapisz(80, 0, tb0);
// zapisz(40, 1, tb1);
// zapisz(40, 2, tb2);
// zapisz(40, 3, tb3);
 ...
 kula:='pm_drab3';
 assignfile(t, 'drab3.asm'); rewrite(t);
 writeln(t, '.local'#9'drab3');
 zapisz(120, 0, tb0);
// zapisz(40, 1, tb1);
// zapisz(40, 2, tb2);
// zapisz(40, 3, tb3);
